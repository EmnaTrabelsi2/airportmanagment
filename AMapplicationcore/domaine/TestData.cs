...
namespace AM.applicationcore.domaine
{
    public class TestData
    {
       ...
       ,
        ...
        public static Flight flight2 = new Flight { FlightDate = new DateTime(2022, 02, 01, 21, 10, 10),Departure="Tunis", Destination = "Paris", EffectiveArrival = new DateTime(2022, 02, 01, 23, 10, 10), EstimatedDuration = 105, Planes = BoingPlane };
